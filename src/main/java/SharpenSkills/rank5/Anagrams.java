 ...
 * https://www.codewars.com/kata/53e57dada0cb0400ba000688/train/java
 Consider a "word" as any sequence of capital letters A-Z (not limited to just "dictionary words"). For any word with
 at least two different letters, there are other words composed of the same letters but in a different order
...
public class Anagrams {
    ...
    public static void main(String[] args) {
        BigInteger bi = BigInteger.valueOf(455452322);
