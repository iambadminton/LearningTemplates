...
public class Dubstep {
    public static String SongDecoder(String song) {
        // Your code is here...
        //return Arrays.stream(song.replaceAll("WUB", " ").split(" ")).map(String::trim).collect(Collectors.joining(" "));
        //return Arrays.stream(song.replaceAll("WUB", " ").split(" ")).map(elem-> elem.replaceAll(" ", "")).collect(Collectors.joining(" "));
